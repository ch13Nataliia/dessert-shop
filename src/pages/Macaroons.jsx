        ...
        <div className="space-y-8 mt-4 px-4 ">
          ...
          <form className="space-y-4 mx-auto ">
              <select className="py-2.5 px-2 w-full text-md text-gray-500 rounded-md bg-gray-100 border-[2px] border-gray-200 cursor-pointer">
                <option selected>Choose box size</option>
                <option value="sm">5 per box</option>
                <option value="md">10 per box</option>
                <option value="lg">20 per box</option>
              </select>
              <select className="py-2.5 px-2 w-full text-md text-gray-500 rounded-md bg-gray-100 border-[2px] border-gray-200 cursor-pointer">
                <option selected>Select a Flavour</option>
                <option value="sm">Banana</option>
                <option value="md">Chocolate</option>
                <option value="lg">Raspberry</option>
                <option value="lg">Strawberry</option>
              </select>
              ...
              <textarea
                id="message"
                rows="4"
                className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg cursor-pointer border border-gray-300 "
