...
import Image1 from '../assets/birthdayBox.webp';
        ...
        <div>
          <div className="grid lg:grid-cols-1 text-right pr-6">
            <div className="flex flex-col  gap-4 pt-12 mt-10 sm:pt-0 text-right">
              <h3 className="uppercase text-3xl text-pink-500">Birthday boxes </h3>
        ...
        <div className="grid sm:grid-cols-1 lg:grid-cols-2  ">
          ...
          <div className="space-y-8 mt-4 px-4">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl text-gray-500 ">Birthday Box</h1>
